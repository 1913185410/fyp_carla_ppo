...
def create_reward_fn(reward_fn, max_speed=-1):
    ...
    def func(env):
        ...
        # Stop if the car is collision
        if env.collision_status = True:
            env.terminal_state = True
            terminal_reason = "the car has collision"
...
reward_functions["ray_reward_function"] = create_reward_fn(ray_reward_function)
