...
class CarlaLapEnv(gym.Env):
    ...
    def __init__(self, host="127.0.0.1", port=2000,
                 ...
                 start_carla=True):
    # def __init__(self, host="10.119.184.95", port=2000,
    #              viewer_res=(1280, 720), obs_res=(1280, 720),
    #              reward_fn=None, encode_state_fn=None, 
    #              synchronous=True, fps=30, action_smoothing=0.9,
    #              start_carla=True):
        ...
        os.environ["CARLA_ROOT"] = "/home/carla/Desktop/carla_0.95/PythonAPI/carla"
...
# =================================================Get spawn location ==========================================
            ...
            dstart_wp = self.world.map.get_waypoint(carla.Location(x=-180.0, y=110))
            # dstart_wp = self.world.map.get_waypoint(self.world.map.get_spawn_points()[1].location)
            # end_wp = self.world.map.get_waypoint(self.world.map.get_spawn_points()[1].location)
            spawn_transform = dstart_wp.transform
        ...
        # self.route_waypoints = compute_route_waypoints(self.world.map, dstart_wp, end_wp, resolution=1.0)
        self.route_waypoints = compute_route_waypoints(self.world.map, dstart_wp, dstart_wp, resolution=1.0,
    ...
    def reset(self, is_training=True):
        ...
        self.collision_status = "False" #def the collision status will reset
    ...
    def render(self, mode="human"):
        ...
        self.extra_info.extend([
            ...
            "Had Collision      %11s"       % self.collision_status,
    ...
    def _on_collision(self, event):
        ...
        self.collision_status = True # set that for detect the collision status
